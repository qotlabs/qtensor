...
plt.plot(data_x, fid_mean_result_40_ort, '--', lw=3, alpha=1, color='red',
         label=r'$\langle f_n \rangle, N = 40, \chi = 64$' + ' ort')
plt.plot(data_x, fid_mean_result_40, '--', lw=3, alpha=0.3, color='red',
         label=r'$\langle f_n \rangle, N = 40, \chi = 64$')
# plt.plot(data_x, fid_result_60, lw=1, alpha=1, color='magenta', label=r'$N = 60, \chi = 64$')
plt.plot(data_x, fid_mean_result_60_ort, '--', lw=3, alpha=1, color='magenta',
