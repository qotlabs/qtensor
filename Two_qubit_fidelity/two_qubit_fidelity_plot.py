...
plt.plot(data_x, fid_mean_result_40, '--', lw=5, alpha=1, color='red', label=r'$\langle f_n \rangle, N = 40, \chi = 64$')
# plt.plot(data_x, fid_result_60, lw=1, alpha=1, color='magenta', label=r'$N = 60, \chi = 64$')
plt.plot(data_x, fid_mean_result_60, '--', lw=5, alpha=1, color='magenta',
