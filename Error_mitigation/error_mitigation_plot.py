...
fig, ax = plt.subplots()
# plt.scatter(fid_start_start, fid_start_start, lw=1, alpha=1, color='red', label='Start')
# plt.scatter(fid_start_start, fid_finish_start, lw=1, alpha=1, color='green', label='Finish')
